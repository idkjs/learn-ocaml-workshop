...
module For_testing = {
  let test_ex_red: stoplight = ({location: "", color: Red}: stoplight);
  let test_ex_red': stoplight = ({...test_ex_red, color: Green}: stoplight);
  let test_ex_yellow: stoplight = ({location: "", color: Yellow}: stoplight);
  let test_ex_yellow': stoplight = ({...test_ex_red, color: Red}: stoplight);
  let test_ex_green: stoplight = ({location: "", color: Green}: stoplight);
  let test_ex_green': stoplight = (
    {...test_ex_red, color: Yellow}: stoplight
  );
