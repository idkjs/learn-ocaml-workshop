...
let one_card_value: card_value = (Queen: card_value);
let another_card_value: card_value = (Number(8): card_value);
...
/* Recall that ['a] is called a type parameter, for which any other type may be
   ...
   integer list. */
type another_int_list = generic_list(int);
